        ...
        <div class="row text-center">
          ...
          <div class="col-xl-3 col-sm-6 mb-5">
            <div class="bg-white rounded shadow-sm py-5 px-4"><img
              ...
              <h5 class="mb-0">Sanjana Panjala</h5><span class="small text text-muted">Head Baker</span>
          ...
          <div class="col-xl-3 col-sm-6 mb-5">
            <div class="bg-white rounded shadow-sm py-5 px-4"><img src="/Mohith-Picture.png" alt="" width="125" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm" />
              ...
              <p> Mohith is responsible for managing the technological requirements of Distributed Danishes. He integrates new technology trends and ensures that it meets the needs of the company.
                 He recently got his MBA from The Ohio State University. He has been working on the team since 2021.</p>
            </div>
          </div>

          <div class="col-xl-3 col-sm-6 mb-5">
            <div class="bg-white rounded shadow-sm py-5 px-4"><img src="/Pranjal-Picture.jpg" alt="" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm" />
              <h5 class="mb-0">Pranjal Suri</h5><span class="small text-uppercase text-muted">Chief Executive Officer</span>
              <p>Pranjal Suri is the CEO of Distributed Danishes. She manages the overall operations of the company by making high level decisions, developing operational strategies, and communicating with the board of directors.</p>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-sm-6 mb-5">
            <div class="bg-white rounded shadow-sm py-5 px-4"><img src="/Ryan-Picture.jpg" alt="" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm" />
              ...
              <p>Ryan is responsible for establishing and maintaining the enterprise vision, strategy, and program to ensure information assests and technologies are protected.
                 He recently got his MBA from The Ohio State University. He has been working on the team since 2021.</p>
            </div>
          </div>
